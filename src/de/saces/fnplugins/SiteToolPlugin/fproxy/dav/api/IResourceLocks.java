...
public interface IResourceLocks {
     ...
     */
    ILockedObject getLockedObjectByID(ITransaction transaction, String id);
     ...
     * @return LockedObject or null if no LockedObject on specified path exists
     */
    ILockedObject getLockedObjectByPath(ITransaction transaction, String path);
     ...
     * @return LockedObject or null if no LockedObject on specified path exists
     */
    ILockedObject getTempLockedObjectByID(ITransaction transaction, String id);
     ...
     * @return LockedObject or null if no LockedObject on specified path exists
     */
    ILockedObject getTempLockedObjectByPath(ITransaction transaction, String path);
