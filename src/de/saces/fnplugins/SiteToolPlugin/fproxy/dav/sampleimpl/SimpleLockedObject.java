 ...
 * 
 */
public class SimpleLockedObject implements ILockedObject {

    private SimpleResourceLocks _resourceLocks;
     ...
     */
    protected SimpleLockedObject[] _children = null;

    protected SimpleLockedObject _parent = null;
     ...
     */
    public SimpleLockedObject(SimpleResourceLocks resLocks, String path, boolean temporary) {
        _path = path;
     ...
     *      new child
     */
    public void addChild(SimpleLockedObject newChild) {
        if (_children == null) {
            _children = new SimpleLockedObject[0];
        }
        int size = _children.length;
        SimpleLockedObject[] newChildren = new SimpleLockedObject[size + 1];
     ...
     * @return owners
     */
    public ILockedObject[] getChildren() {
        return _children;
    }
